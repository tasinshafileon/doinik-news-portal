            ...
            <div class="top-menu">
                ...
                <div class="container">
                    ...
                    <ul class="left-top-menu">
                        ...
                        <li class="address">
                            <a href="#"><i class="fa fa-phone"></i> +00 (123) 456
                                7890</a>
                        </li>
                        <li class="address">
                                                ...
                                                <div class="media-body">
                                                    <p>
                                                        <a href="news.html" target="_blank"><span
                                                                class="bg-1">News</span></a><a
                                                            href="news.html">Thousands of
                                                            people have
                                                            demonstrated
                                                            against...</a>
                                                    </p>
                                                ...
                                                <div class="media-body">
                                                    <p>
                                                        <a href="sport.html" target="_blank"><span
                                                                class="bg-4">Sport</span></a><a
                                                            href="sport.html">Europe's top
                                                            four leagues are
                                                            to be guaranteed
                                                            four
                                                            places...</a>
                                                ...
                                                <div class="media-body">
                                                    <p>
                                                        <a href="health.html" target="_blank"><span
                                                                class="bg-2">Health</span></a><a
                                                            href="health.html">Robot performs
                                                            surgery on soft
                                                            tissue better
                                                            than human...</a>
                                                    </p>
                                                ...
                                                <div class="media-body">
                                                    <p>
                                                        <a href="lifestyle.html" target="_blank"><span
                                                                class="bg-9">Lifestyle</span></a><a
                                                            href="lifestyle.html">A positive
                                                            lifestyle can
                                                            bring you
                                                            happiness...</a>
                                                    </p>
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div class="news">
                                ...
                                <div class="item">
                                    <div class="item-image-1">
                                        <a class="img-link" href="#"><img class="img-responsive img-full"
                                                src="{{ url('img/index_800x400-image01.jpg') }}" alt="" /></a><span><a
                                                class="label-1" href="news.html">News</a></span>
                                    </div>
                                ...
                                <div class="item">
                                    <div class="item-image-1">
                                        <a class="img-link" href="#"><img class="img-responsive img-full"
                                                src="{{ url('img/index_800x400-image02.jpg') }}" alt="" /></a><span><a
                                                class="label-3" href="politics.html">Politics</a></span>
                                    </div>
                                    <div class="item-content">
                                        <div class="title-left title-style04 underline04">
                                            <h3>
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div class="news">
                                ...
                                <div class="item">
                                    <div class="item-image-1">
                                        <a class="img-link" href="#"><img class="img-responsive img-full"
                                                src="{{ url('img/index_800x400-image03.jpg') }}" alt="" /></a><span><a
                                                class="label-5" href="tech-science.html">Science</a></span>
                                    </div>
                                    <div class="item-content">
                                        <div class="title-left title-style04 underline04">
                                            <h3>
                                ...
                                <div class="item">
                                    <div class="item-image-1">
                                        <a class="img-link" href="#"><img class="img-responsive img-full"
                                                src="{{ url('img/index_800x400-image04.jpg') }}" alt="" /></a><span><a
                                                class="label-2" href="health.html">Health</a></span>
                                    </div>
                                    <div class="item-content">
                                        <div class="title-left title-style04 underline04">
                                            <h3>
                            ...
                            <div class="news">
                                ...
                                <div class="item">
                                    <div class="item-image-2">
                                        <a class="img-link" href="#"><img class="img-responsive img-full"
                                                src="{{ url('img/index_800x400-image05.jpg') }}" alt="" /></a><span><a
                                                class="label-2" href="politics.html">Politics</a></span>
                                    </div>
                                    <div class="item-content">
                                        <div class="title-left title-style04 underline04">
                                            <h3>
                                ...
                                <div class="item">
                                    <div class="item-image-2">
                                        <a class="img-link" href="#"><img class="img-responsive img-full"
                                                src="{{ url('img/index_800x400-image06.jpg') }}" alt="" /></a><span><a
                                                class="label-1" href="news.html">News</a></span>
                                    </div>
                                    <div class="item-content">
                                        <div class="title-left title-style04 underline04">
                                ...
                                <div class="item">
                                    <div class="item-image-2">
                                        <a class="img-link" href="#"><img class="img-responsive img-full"
                                                src="{{ url('img/index_800x400-image07.jpg') }}" alt="" /></a><span><a
                                                class="label-5" href="business.html">Economy</a></span>
                                    </div>
                                    <div class="item-content">
                                        <div class="title-left title-style04 underline04">
                                            <h3>
                                            ...
                                            <div class="item">
                                                <div class="item-image">
                                                    <a class="img-link" href="#"><img
                                                            ...
                                                            src="{{ url('img/index_370x185-image01.jpg') }}" alt="" /></a>
                                                </div>
                                                <div class="item-content">
                                                    <h4 class="ellipsis">
                                        ...
                                        <li>
                                            <div class="item">
                                                <div class="item-image">
                                                    <a class="img-link" href="#"><img
                                                            class="img-responsive img-full"
                                                            src="{{ url('img/index_370x185-image02.jpg') }}" alt="" /></a>
                                                </div>
                                                <div class="item-content">
                                                    <h4 class="ellipsis">
                                                        <a href="#">One Type of
                                        ...
                                        <li>
                                            <div class="item">
                                                <div class="item-image">
                                                    <a class="img-link" href="#"><img
                                                            class="img-responsive img-full"
                                                            src="{{ url('img/index_370x185-image03.jpg') }}" alt="" /></a>
                                                </div>
                                                <div class="item-content">
                                                    <h4 class="ellipsis">
                                                        <a href="#">Preschool</a>
                                        ...
                                        <li>
                                            <div class="item">
                                                <div class="item-image">
                                                    <a class="img-link" href="#"><img
                                                            class="img-responsive img-full"
                                                            src="{{ url('img/index_370x185-image04.jpg') }}" alt="" /></a>
                                                </div>
                                                <div class="item-content">
                                                    <h4 class="ellipsis">
                                                        <a href="#">Antarctica
                                        ...
                                        <li>
                                            <div class="item">
                                                <div class="item-image">
                                                    <a class="img-link" href="#"><img
                                                            class="img-responsive img-full"
                                                            src="{{ url('img/index_370x185-image05.jpg') }}" alt="" /></a>
                                                </div>
                                                <div class="item-content">
                                                    <h4 class="ellipsis">
                                                        <a href="#">Yellow fever
                                        ...
                                        <li>
                                            <div class="item">
                                                <div class="item-image">
                                                    <a class="img-link" href="#"><img
                                                            class="img-responsive img-full"
                                                            src="{{ url('img/index_370x185-image06.jpg') }}" alt="" /></a>
                                                </div>
                                                <div class="item-content">
                                                    <h4 class="ellipsis">
                                    ...
                                    <div class="news">
                                        <div class="item">
                                            <div class="item-image-3">
                                                <a class="img-link" href="#"><img class="img-responsive img-full"
                                                        src="{{ url('img/index_800x400-image09.jpg') }}" alt="" /></a><span><a
                                                        class="label-1" href="news.html">Breaking News</a></span>
                                            </div>
                                            <div class="item-content">
                                                <div class="title-left title-style04 underline04">
                                                    <h3>
                                                ...
                                                <div>
                                                    <a href="watch-live.html" target="_blank"><span
                                        ...
                                        <div class="item">
                                            <div class="item-image-3">
                                                <a class="img-link" href="#"><img class="img-responsive img-full"
                                                        src="{{ url('img/index_800x400-image10.jpg') }}" alt="" /></a><span><a
                                                        class="label-4" href="travel.html">Sport</a></span>
                                            </div>
                                            <div class="item-content">
                                                <div class="title-left title-style04 underline04">
                                                    <h3>
                                        ...
                                        <div class="item">
                                            <div class="item-image-3">
                                                <a class="img-link" href="#"><img class="img-responsive img-full"
                                                        src="{{ url('img/index_800x400-image11.jpg') }}" alt="" /></a><span><a
                                                        class="label-9" href="soccer.html">Lifestyle</a></span>
                                            </div>
                                            <div class="item-content">
                                                <div class="title-left title-style04 underline04">
                                                    <h3>
                                        ...
                                        <div class="item">
                                            <div class="item-image-3">
                                                <a class="img-link" href="#"><img class="img-responsive img-full"
                                                        src="{{ url('img/index_800x400-image12.jpg') }}" alt="" /></a><span><a
                                                        class="label-3" href="health.html">Travel</a></span>
                                            </div>
                                            <div class="item-content">
                                                <div class="title-left title-style04 underline04">
                                                    <h3>
                                        ...
                                        <div class="item">
                                            <div class="item-image-3">
                                                <a class="img-link" href="#"><img class="img-responsive img-full"
                                                        src="{{ url('img/index_800x400-image13.jpg') }}" alt="" /></a><span><a
                                                        class="label-6" href="health.html">Web Shows</a></span>
                                            </div>
                                            <div class="item-content">
                                                <div class="title-left title-style04 underline04">
                                                    <h3>
            ...
            <section class="module">
                ...
                <div class="container">
                    ...
                    <div id="big-gallery-slider-3" class="owl-carousel">
                        ...
                        <div class="big-gallery">
                            <img src="{{ url('img/index_slider-large-image03.jpg') }}" alt="" /><a href="video.html"><span
                                    class="play-icon"></span></a>
                        </div>
                        <div class="big-gallery">
                            <img src="{{ url('img/index_slider-large-image04.jpg') }}" alt="" /><a href="video.html"><span
                                    class="play-icon"></span></a>
                        </div>
                        <div class="big-gallery">
                            <img src="{{ url('img/index_slider-large-image05.jpg') }}" alt="" /><a href="video.html"><span
                                    class="play-icon"></span></a>
                        </div>
                        <div class="big-gallery">
                            <img src="{{ url('img/index_slider-large-image06.jpg') }}" alt="" /><a href="video.html"><span
                                    class="play-icon"></span></a>
                        </div>
                    </div>
                                    ...
                                    <div class="sidebar-schedule-slide">
                                        <div class="sidebar-schedule-slider-layer full">
                                            <a href="news.html">
                                                ...
                                                <img src="{{ url('img/sidebar-schedule_slider-image01.jpg') }}" alt="" />
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End .schedule-slide -->
                                    ...
                                    <div class="sidebar-schedule-slide">
                                        <div class="sidebar-schedule-slider-layer full">
                                            <a href="news.html">
                                                ...
                                                <img src="{{ url('img/sidebar-schedule_slider-image02.jpg') }}" alt="" />
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End .schedule-slide -->
                                    ...
                                    <div class="sidebar-schedule-slide">
                                        <div class="sidebar-schedule-slider-layer full">
                                            <a href="news.html">
                                                ...
                                                <img src="{{ url('img/sidebar-schedule_slider-image03.jpg') }}" alt="" />
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End .schedule-slide -->
                    ...
                    <div class="row no-gutter">
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-3">
                            ...
                            <div class="module-media">
                                <div class="image">
                                    <img class="img-responsive" src="{{ url('img/index_620x465-image04.jpg') }}" alt="" />
                                </div>
                                <a href="video.html"><span class="play-icon"></span></a>
                            </div>
                            <div class="module-media">
                                <div class="image">
                                    <img class="img-responsive" src="{{ url('img/index_620x465-image02.jpg') }}" alt="" />
                                </div>
                                <a href="video.html"><span class="play-icon"></span></a>
                            </div>
                        </div>
                                    ...
                                    <li>
                                        <div class="item">
                                            <div class="item-image">
                                                <a class="img-link" href="#"><img
                                                        class="img-responsive img-full"
                                                        src="{{ url('img/index_370x185-image07.jpg') }}" alt="" /></a>
                                            </div>
                                            <div class="item-content">
                                                <h3>01</h3>
                                                <p class="ellipsis">
                                    ...
                                    <li>
                                        <div class="item">
                                            <div class="item-image">
                                                <a class="img-link" href="#"><img
                                                        class="img-responsive img-full"
                                                        src="{{ url('img/index_370x185-image08.jpg') }}" alt="" /></a>
                                            </div>
                                            <div class="item-content">
                                                <h3>02</h3>
                                                <p class="ellipsis">
                                    ...
                                    <li>
                                        <div class="item">
                                            <div class="item-image">
                                                <a class="img-link" href="#"><img
                                                        class="img-responsive img-full"
                                                        src="{{ url('img/index_370x185-image09.jpg') }}" alt="" /></a>
                                            </div>
                                            <div class="item-content">
                                                <h3>03</h3>
                                                <p class="ellipsis">
                                    ...
                                    <li>
                                        <div class="item">
                                            <div class="item-image">
                                                <a class="img-link" href="#"><img
                                                        class="img-responsive img-full"
                                                        src="{{ url('img/index_370x185-image10.jpg') }}" alt="" /></a>
                                            </div>
                                            <div class="item-content">
                                                <h3>04</h3>
                                                <p class="ellipsis">
                                    ...
                                    <li>
                                        <div class="item">
                                            <div class="item-image">
                                                <a class="img-link" href="#"><img
                                                        class="img-responsive img-full"
                                                        src="{{ url('img/index_370x185-image11.jpg') }}" alt="" /></a>
                                            </div>
                                            <div class="item-content">
                                                <h3>05</h3>
                                                <p class="ellipsis">
                                    ...
                                    <li>
                                        <div class="item">
                                            <div class="item-image">
                                                <a class="img-link" href="#"><img
                                                        class="img-responsive img-full"
                                                        src="{{ url('img/index_370x185-image12.jpg') }}" alt="" /></a>
                                            </div>
                                            <div class="item-content">
                                                <h3>06</h3>
                                                <p class="ellipsis">
                                    ...
                                    <li>
                                        <div class="item">
                                            <div class="item-image">
                                                <a class="img-link" href="#"><img
                                                        class="img-responsive img-full"
                                                        src="{{ url('img/index_370x185-image13.jpg') }}" alt="" /></a>
                                            </div>
                                            <div class="item-content">
                                                <h3>07</h3>
                                                <p class="ellipsis">
                                    ...
                                    <li>
                                        <div class="item">
                                            <div class="item-image">
                                                <a class="img-link" href="#"><img
                                                        class="img-responsive img-full"
                                                        src="{{ url('img/index_370x185-image14.jpg') }}" alt="" /></a>
                                            </div>
                                            <div class="item-content">
                                                <h3>08</h3>
                                                <p class="ellipsis">
                                    ...
                                    <li>
                                        <div class="item">
                                            <div class="item-image">
                                                <a class="img-link" href="#"><img
                                                        class="img-responsive img-full"
                                                        src="{{ url('img/index_370x185-image15.jpg') }}" alt="" /></a>
                                            </div>
                                            <div class="item-content">
                                                <h3>09</h3>
                                                <p class="ellipsis">
                        ...
                        <div class="col-md-4">
                            ...
                            <form class="conversionForm">
                                <div class="conversionForm-amount">
                                    ...
                                    <input type="number" class="currencyValue form-control no-spinners"
                                ...
                                <div class="sidebar-newsletter-form">
                                    <form class="form-horizontal"
                                        ...
                                        <div class="input-group">
                                            <input title="Newsletter" class="form-control" name="email"
                                                type="email" id="address" placeholder="Enter Your Email Address"
                ...
                <div class="container">
                    ...
                    <div id="small-gallery-slider" class="owl-carousel">
                        <div class="small-gallery">
                            <img class="img-responsive" src="{{ url('img/index_108x108_slider-image01.jpg') }}" alt="" />
                        ...
                        <div class="small-gallery">
                            <img class="img-responsive" src="{{ url('img/index_108x108_slider-image02.jpg') }}" alt="" />
                            <div class="post-content">
                        ...
                        <div class="small-gallery">
                            <img class="img-responsive" src="{{ url('img/index_108x108_slider-image03.jpg') }}" alt="" />
                            <div class="post-content">
                                <a href="web-shows.html">Web Shows </a>
                                <p>
                        ...
                        <div class="small-gallery">
                            <img class="img-responsive" src="{{ url('img/index_108x108_slider-image04.jpg') }}" alt="" />
                            <div class="post-content">
                        ...
                        <div class="small-gallery">
                            <img class="img-responsive" src="{{ url('img/index_108x108_slider-image05.jpg') }}" alt="" />
                            <div class="post-content">
                                <a href="business.html">Business </a>
                                <p>
                    ...
                    <div class="container">
                        <div class="row no-gutter">
                                        ...
                                        <li>
                                            <div class="item">
                                                <div class="item-image">
                                                    <a class="img-link" href="deals.html"><img
                                                            class="img-responsive img-full"
                                                            src="{{ url('img/food_370x185-image05.jpg') }}" alt="" /></a>
                                                </div>
                                                <div class="item-content">
                                                    <p class="ellipsis">
                                                        <a href="#">The consumer
                                        ...
                                        <li>
                                            <div class="item">
                                                <div class="item-image">
                                                    <a class="img-link" href="deals.html"><img
                                                            class="img-responsive img-full"
                                                            src="{{ url('img/index_370x185-image16.jpg') }}" alt="" /></a>
                                                </div>
                                                <div class="item-content">
                                                    <p class="ellipsis">
                            ...
                            <div class="col-sm-6 col-md-3">
                                ...
                                <div class="tagcloud">
                                    <a href="#">News</a><a href="#">Sports</a><a
                                        href="#">Schedule</a><a href="#">Health</a><a
                                        href="#">Business</a><a href="#">Travel</a><a
                                        href="#">Autos</a><a href="#">Deals</a><a
                                        ...
                                        href="#">Advertising</a><a href="#">Android</a><a
                                        href="#">Live Feed</a>
                                </div>
                            </div>
                        </div>
